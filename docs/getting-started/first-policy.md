...
- [Operational Modes](../concepts/modes.md) - Deep dive into Auto, Recommend, and Disabled modes
- [Update Strategies](../concepts/update-strategies.md) - Learn about SSA vs Webhook strategies
- [CRD Reference](../reference/crd-spec.md) - Complete field documentation
- [Example Policies](../reference/examples.md) - More policy examples

---

*For advanced configuration options, see the [CRD Reference](../reference/crd-spec.md).*
