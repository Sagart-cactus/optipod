...
- [Installation Guide](/docs/getting-started/installation) - Installation instructions
- [CRD Specification](/docs/reference/crd-spec) - OptimizationPolicy field reference
- [Prometheus Authentication](https://github.com/Sagart-cactus/optipod/blob/main/docs/PROMETHEUS_AUTHENTICATION.md) - Prometheus auth setup
- [Webhook Configuration](/docs/advanced/webhook-config) - Advanced webhook configuration
