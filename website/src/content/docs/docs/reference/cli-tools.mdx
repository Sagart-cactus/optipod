---
title: CLI Tools and Scripts Reference
description: Complete reference for OptiPod command-line tools and utility scripts
---
...
- [Annotations Reference](/docs/reference/annotations) - Annotation format used by recommendation report
- [Reviewing Recommendations](/docs/guides/reviewing-recs) - Guide to reviewing recommendations
- [CRD Specification](/docs/reference/crd-spec) - OptimizationPolicy field reference
- [Contributing Guide](https://github.com/Sagart-cactus/optipod/blob/main/CONTRIBUTING.md) - Development workflow and guidelines
