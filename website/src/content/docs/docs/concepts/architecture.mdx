---
title: Architecture
description: OptiPod system architecture and core components
---
...
- [Modes](modes) - Operational modes (Recommend, Auto, Disabled)
- [Safety Model](safety-model) - Safety guarantees and constraints
- [Update Strategies](update-strategies) - SSA vs Webhook strategies
- [Installation Guide](../getting-started/installation) - Deployment instructions
