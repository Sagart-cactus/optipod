...
1. [Install OptiPod](/docs/getting-started/installation) in your cluster
2. [Create your first policy](/docs/guides/creating-policies)
3. [Review recommendations](/docs/guides/reviewing-recommendations)
4. [Switch to Auto mode](/docs/guides/switching-to-auto) when ready
